<main class="container mx-auto px-4 pt-20 pb-20">
    ...
    <form method="POST" class="max-w-md mx-auto bg-gray-800 p-6 rounded-lg shadow-lg">
        ...
        <button type="submit" class="w-full bg-red-600 text-white py-2 rounded-lg">Se connecter</button>
        <div class="mt-4 text-center">
            <p class="text-sm">
                Pas encore de compte ? 
                <a href="/Cinetech/register" class="text-red-600 hover:underline">S'inscrire</a>
            </p>
        </div>
    </form>
</main>